...
contract FriendtechSharesV1 is Ownable {
    ...
    function getPrice(
        ...
        require(supply >= 0, "Supply underflow");
        ...
        // require(sum1 <= sum2, "Potential underflow in sum2 - sum1 calculation");

        // uint256 summation = sum2 - sum1;
        // uint256 finalPrice = (summation * 1 ether) / 16000;

        // require(finalPrice > 0, "Price should be greater than 0");
        return finalPrice;
    }
    ...
    function sellShares(address sharesSubject, uint256 amount) public payable {
        ...
        require(protocolFee >= 0, "Protocol fee underflow");
        require(subjectFee >= 0, "Subject fee underflow");
        require(price >= protocolFee + subjectFee, "Fees exceed price");
        ...
        require(success3, "Unable to send subject fee");
    }
}
